  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-4">
      ...
      <div className="max-w-2xl space-y-4 text-left">
        <p>
          Welcome to our AI Resume Builder. By using our service, you agree to
          the following terms and conditions. Please read them carefully.
        </p>
        <h2 className="text-2xl font-semibold">1. Acceptance of Terms</h2>
        <p>
          By accessing and using our AI Resume Builder, you accept and agree to
        ...
        <p>
          Our AI Resume Builder provides users with tools to create and manage
          resumes. You understand and agree that the service is provided
        ...
        <p>
          ...
          responsible for your use of and communications on the service. You
          agree not to post or transmit any unlawful, harmful, threatening,
          abusive, harassing, defamatory, vulgar, obscene, or otherwise
          objectionable material of any kind.
        </p>
        <h2 className="text-2xl font-semibold">4. Modifications to Service</h2>
        <p>
          We reserve the right to modify or discontinue, temporarily or
          permanently, the service (or any part thereof) with or without notice
          at any time. You agree that we shall not be liable to you or to any
