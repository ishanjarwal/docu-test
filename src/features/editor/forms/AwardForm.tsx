...
interface AwardValues {
  awards?: CommonAchievementValues;
}
const AwardSchema = z.object({
  awards: CommonAchievementSchema,
});

const AwardForm = ({ resumeData, setResumeData }: EditorFormProps) => {
  ...
  useEffect(() => {
    const { unsubscribe } = form.watch(async (values) => {
      ...
      setResumeData({
        ...resumeData,
        achievements: values.awards?.filter((item) => item !== undefined) || [],
      });
    });
            ...
            <div className="flex w-full items-center justify-between gap-x-4">
              ...
              <div className="flex w-full items-center justify-between truncate">
                <p className="truncate text-lg font-semibold">
                  {form.watch("awards")?.[index]?.title || "untitled"}
                </p>
                <span>
                  <FaChevronDown />
                </span>
                ...
                <div className="col-span-2">
                  <CustomFormField
                    props={{
                      ...
                      fieldType: "text",
                      label: "Award title",
                      placeholder: "The title of your award",
                    }}
                    control={control}
                  />
                </div>
                ...
                <div className="col-span-2 md:col-span-1">
                  <CustomFormField
                    props={{
                      ...
                      fieldType: "text",
                      label: "Link to your award",
                      placeholder: "Link to your award",
                    }}
                    control={control}
                  />
                </div>
              ...
              <div className="flex items-center justify-end">
                <Label className="flex cursor-pointer items-center justify-center space-x-2">
                  ...
                  <Checkbox
                    checked={yearOnly}
                    onCheckedChange={() => {
                      form.setValue(`awards.${index}.startDate`, "");
                      form.setValue(`awards.${index}.endDate`, "");
